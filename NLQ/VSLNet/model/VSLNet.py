...
class VSLNet(nn.Module):
    def __init__(self, configs, word_vectors):
        ...
        #PROVIAMO A FARE DUE ISTANZE SEPARATE PER ENCODER VIDEO E QUESRY
        self.feature_encoder_query = FeatureEncoder(
            dim=configs.dim,
    ...
    def forward(self, word_ids, char_ids, video_features, v_mask, q_mask):
        ...
        query_features = self.feature_encoder_query(query_features, mask=q_mask)
